...
function FooterMid() {
  return (
    <div className=" flex flex-col justify-center items-center p-10 space-y-6 border-gr border-b-2 lg:flex lg:flex-row lg:space-y-0 lg:justify-between lg:px-14 ">
      <div className="footer-mid-left flex space-x-9">
        <a href="/">
          <svg
      ...
      <div className="footer-mid-mid text-sm flex space-x-3 lg:text-lg ">
        <h3>Check out our store for your </h3>
        <h3 className="font-bold">needed</h3>
      </div>
      <div className="footer-mid-right flex space-x-9">
        <a href="/">
          <img
            src="https://i.pinimg.com/1200x/e2/33/f5/e233f5b0c5a358449398f202b03f063a.jpg"
            alt=""
            width={36}
          />
        </a>
        <a href="/">
          <img
            src="https://www.acledabank.com.kh/kh/assets/layout/logo-white.png"
            alt=""
            width={36}
          />
        </a>
